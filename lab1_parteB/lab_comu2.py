...
# Title: frecuencia_muestreo
# Author: Maria_Valenzuela_Johan_Castillo_J1E_G4
...
class lab_comu2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "frecuencia_muestreo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("frecuencia_muestreo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab_comu2")
...
def main(top_block_cls=lab_comu2, options=None):
