...
class parte3_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "parte3_3")
        ...
        self._fm_range = Range(0, 10000, 100, 1000, 200)
...
def main(top_block_cls=parte3_3, options=None):
