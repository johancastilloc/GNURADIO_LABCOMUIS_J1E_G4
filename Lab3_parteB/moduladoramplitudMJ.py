...
class moduladoramplitudMJ(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "moduladoramplitudMJ")
...
def main(top_block_cls=moduladoramplitudMJ, options=None):
